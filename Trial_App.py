...
def insertDonor(donorID,fname,lname,email,dob,Bloodtype,DocNo,age,gender,address,contactno):
	insert = "INSERT INTO donors(donorID,fname,lname,email,dob,Bloodtype,DocNo,age,gender,address,contactno) 
            VALUES('"+donorID+"','"+fname+"','"+lname+"','"+email+"','"+dob+"','"+Bloodtype+"','"+DocNo+"','"+age+"','"+gender+"','"+address+"',"+"'"+contactno+"')"
	try:
...
##### Need more editing from this part
